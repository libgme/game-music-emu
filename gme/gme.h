...
gme_err_t gme_open_file( const char path [], Music_Emu** out, int sample_rate, bool multi_channel = false );
...
gme_err_t gme_open_data( void const* data, long size, Music_Emu** out, int sample_rate, bool multi_channel = false );
...
Music_Emu* gme_new_emu( gme_type_t, int sample_rate, bool multi_channel = false );
